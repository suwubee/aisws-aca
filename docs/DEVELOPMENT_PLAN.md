...
### Phase 1: 项目基础架构 (Sprint 1)

#### 1.1 后端基础架构
- [ ] 初始化Go项目结构
- [ ] 配置Fiber/Gin框架
- [ ] 设置GORM + SQLite
- [ ] 实现基础中间件（日志、CORS、错误处理）
- [ ] 创建数据库迁移脚本
